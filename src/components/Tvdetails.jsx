  ...
  if (loadFailed && !info) {
    return (
      <div className='w-full h-screen flex flex-col justify-center items-center bg-zinc-900'>
        ...
        <h1 className='text-white text-2xl font-bold mb-2'>Failed to load TV Show</h1>
        <p className='text-zinc-400 text-center mb-6'>Could not fetch details. Please check your connection.</p>
        <div className="flex gap-4">
          <button
            onClick={() => { setLoadFailed(false); dispatch(asyncloadtv(id)); setTimeout(() => setLoadFailed(true), 12000); }}
    ...
    return (
      <div className='w-full h-screen flex justify-center items-center bg-zinc-900'>
        <div className='flex flex-col items-center gap-4'>
          ...
          <p className='text-zinc-400'>Loading TV show details...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="ml-8">
          <h1 className="text-[40px] font-semibold text-white text-center mt-2">
            ...
            {info.detail.first_air_date &&
              <small className="text-xl"> ({info.detail.first_air_date.split("-")[0]})</small>
            }
          </h1>
          ...
          <div className="flex mt-5 gap-5">
            ...
            <h1 className="mt-5 text-zinc-50">User Score — {info.detail.first_air_date}</h1>
